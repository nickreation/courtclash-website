...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `${dict.sections.cookiesPage.title} – Court Clash`,
    description: dict.sections.cookiesPage.intro,
  };
}
...
export default async function PolitiqueCookiesPage({ params }: PageProps) {
  ...
  const dict = await getDictionary(locale as Locale);
  const t = dict;
  const cookies = t.sections.cookiesPage;
    ...
    <>
      ...
      <main className="min-h-screen pt-16">
        <div className="mx-auto max-w-3xl px-4 py-12 md:py-16">
          ...
          <p className="mt-4 text-lg text-text-secondary">{cookies.intro}</p>
          ...
          <p className="mt-10 text-text-secondary">{cookies.closing}</p>
        ...
        <footer className="mt-16 border-t border-border bg-surface px-4 py-12">
          <div className="mx-auto max-w-5xl">
            <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
              <div className="text-center md:text-left">
                ...
                <div className="mt-3 flex justify-center gap-4 text-hero-gradient md:justify-start">
                  <a
